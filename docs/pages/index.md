...
The Python SDK, `nveil` CLI and MCP server for NVEIL. Drive the platform from a script, your terminal or an AI agent. Describe what you want; NVEIL plans the processing and visualization, and the Toolkit runs it **locally**, so your raw data never leaves your machine.
